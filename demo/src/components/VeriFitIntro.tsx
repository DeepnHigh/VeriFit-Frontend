      ...
      <div className="bg-gray-50 rounded-2xl p-8 mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white rounded-2xl p-6 text-center shadow-lg hover:transform hover:-translate-y-1 transition-transform duration-300">
            ...
            <p className="text-gray-600 leading-relaxed" style={{ wordBreak: 'keep-all', wordWrap: 'break-word' }}>자기소개서, 포트폴리오, GitHub 링크 등을 한 번만 업로드하면 모든 기업 지원에 활용됩니다.</p>
          </div>
          <div className="bg-white rounded-2xl p-6 text-center shadow-lg hover:transform hover:-translate-y-1 transition-transform duration-300">
            <div className="text-4xl mb-4">🤖</div>
          ...
          <div className="bg-white rounded-2xl p-6 text-center shadow-lg hover:transform hover:-translate-y-1 transition-transform duration-300">
            ...
            <p className="text-gray-600 leading-relaxed" style={{ wordBreak: 'keep-all', wordWrap: 'break-word' }}>기존 40시간의 면접 시간을 2시간으로 단축하고, 95%의 시간을 절약할 수 있습니다.</p>
          </div>
          <div className="bg-white rounded-2xl p-6 text-center shadow-lg hover:transform hover:-translate-y-1 transition-transform duration-300">
            <div className="text-4xl mb-4">💰</div>
            <h3 className="text-xl font-semibold text-gray-800 mb-3">비용 절감</h3>
            <p className="text-gray-600 leading-relaxed" style={{ wordBreak: 'keep-all', wordWrap: 'break-word' }}>면접관 인건비 800만원을 AI 평가 비용 50만원으로 줄여 93.8%의 비용을 절감합니다.</p>
          </div>
          <div className="bg-white rounded-2xl p-6 text-center shadow-lg hover:transform hover:-translate-y-1 transition-transform duration-300">
            <div className="text-4xl mb-4">📊</div>
